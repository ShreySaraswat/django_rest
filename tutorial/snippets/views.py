from snippets.models import Snippet, user, user_wallet, type_of_tr, active_tr_usr, transaction_stats, transaction_top_10, transactions, tr_status_map, transaction_failed
from snippets.serializers import SnippetSerializer, WalSerializer, userSerializer, user_walletSerializer, type_of_tr_Serializer, active_tr_usr_Serializer, transaction_stats_Serializer, transaction_top_10_Serializer, transactions_Serializer, tr_status_map_Serializer, transaction_failed_Serializer
...
class WalViewSet(viewsets.ModelViewSet):
    """
    ...
    serializer_class = WalSerializer
